...
case1_knn_name = "BYOL+CIFAR-10+FTrojan [kNN]"
case1_knn_mean = [37.0, 34.5, 30.4]
case1_knn_std = [5.1, 8.2, 7.9]

case1_linear_name = "BYOL+CIFAR-10+FTrojan [Linear]"
case1_linear_mean = [15.5, 13.6, 10.7]
case1_linear_std = [6.3, 9.0, 9.5]

case2_knn_name = "MoCoV2+CIFAR-10+HTBA [kNN]"
case2_knn_mean = [54.2, 50.3, 35.4]
case2_knn_std = [7.1, 7.4, 7.2]

case2_linear_name = "MoCoV2+CIFAR-10+HTBA [Linear]"
case2_linear_mean = [59.8, 52.9, 36.2]
...
# Labels and legend
ax.set_xlabel(
    r"Number of Identified Channels $|\tilde{C}|$",
    fontsize=11,
    labelpad=-2,
)
ax.set_ylabel("ASR%", fontsize=11, labelpad=-2)
ax.legend(
    loc="upper right",
    fontsize=8,

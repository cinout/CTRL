...
all_input_file_paths = [
    "slurm-14681146-[ST:mimic_sd42].out",
    "slurm-14681147.out",
    "slurm-14681148.out",
    "slurm-14681149.out",
    "slurm-14681150.out",
    ...
    "slurm-14681161.out",
    "slurm-14681162.out",
    "slurm-14681163-[END:mimic_sd42].out",
]
...
"""
prefix = "zz_results_"
title = "mimic_sd42_"  # FIXME: change
...
# Cleansed
pattern_knn = (
    r"With MIMIC model, for kNN classifier, clean acc: ([\d.]+), back acc: ([\d.]+)"
)

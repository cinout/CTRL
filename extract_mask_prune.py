...
pattern_mask_0d1 = r".*(layer|bn).*0\.10\s+([\d.]+)\s+([\d.]+)\s*"
pattern_mask_0d3 = r".*(layer|bn).*0\.30\s+([\d.]+)\s+([\d.]+)\s*"
pattern_mask_0d5 = r".*(layer|bn).*0\.50\s+([\d.]+)\s+([\d.]+)\s*"
pattern_mask_0d7 = r".*(layer|bn).*0\.70\s+([\d.]+)\s+([\d.]+)\s*"
pattern_mask_0d9 = r".*(layer|bn).*0\.90\s+([\d.]+)\s+([\d.]+)\s*"
